...
namespace StandaloneSDKDemo
{
    ...
    {
        String demoVersion = "1.0.0";//inserir aqui a versão correta do demo, quando ele for modificado
        ...
        //    lbVer.Text = "Versão do demo:" + demoVersion + "  versão do SDK:" + ver;
        ...
        //    DialogResult dr = ZKMessgeBox.Show("Sair do programa?", "Atenção!", ZKMessgeBox.I8Buttons.OKCancel);
        ...
        private void lbSysOutputInfo_DrawItem(object sender, DrawItemEventArgs e)
        {
            if (e.Index >= 0)
            {
                ...
                if (lbSysOutputInfo.Items[e.Index].ToString().Substring(0, 1) == "*")//se começar com *, a cor da fonte é vermelha   
                {
