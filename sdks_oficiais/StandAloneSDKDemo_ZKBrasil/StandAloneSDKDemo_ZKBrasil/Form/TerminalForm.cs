        ...
        * *******************************************************************************************************************************************/
        ...
        private void btnTCPConnect_Click(object sender, EventArgs e)
        {
            ...
            {        
                ...
                btnTCPConnect.Text = "Desconectar"; //Atualizando o caption do botão
                btnTCPConnect.Refresh();
               
            }
            else if (ret == -2)
            { 
                btnTCPConnect.Text = "Conectar";  //Atualizando o caption do botão
                btnTCPConnect.Refresh();
        ...
        private void btnRSConnect_Click(object sender, EventArgs e)
        {
            ...
            if (ret == 1)
            {
                ...
                btnRSConnect.Text = "Desconectar";
                btnRSConnect.Refresh();
            }
            else if (ret == -2)
            {
                btnRSConnect.Text = "Conectar";
                btnRSConnect.Refresh();
                this.txtDeviceID1.ReadOnly = false;
        ...
        private void btnUSBConnect_Click(object sender, EventArgs e)
        {
            ...
            if (ret == 1)
            {
                ...
                btnUSBConnect.Text = "Desconectar";
                btnUSBConnect.Refresh();
            }
            else if (ret == -2)
            {
                btnUSBConnect.Text = "Conectar";
                btnUSBConnect.Refresh();
