...
namespace StandaloneSDKDemo
{
    ...
    public partial class UserMngForm : Form
    {
        public UserMngForm(Main Parent)
        {
            ...
            UserMng.SDK.biometricTypes.Add("Geral");
            UserMng.SDK.biometricTypes.Add("Digital");
            UserMng.SDK.biometricTypes.Add("Face");
            UserMng.SDK.biometricTypes.Add("Impressão de voz");
            UserMng.SDK.biometricTypes.Add("Iris");
            UserMng.SDK.biometricTypes.Add("Retina");
            UserMng.SDK.biometricTypes.Add("Impressão de Palma");
            UserMng.SDK.biometricTypes.Add("Veias do dedo");
            UserMng.SDK.biometricTypes.Add("Veias da palma");
        ...
        private void btnDeleteEnrollData_Click(object sender, EventArgs e)
        {
            ...
            //Chamada do metodo para apagar dados atrelados ao usuário
        ...
        {
            Cursor = Cursors.WaitCursor;
            //Chamda do metodo para escrever um novo ususário
        ...
        private void btnSetVD_Click(object sender, EventArgs e)
        {
            ...
            //chamda do metodo para definir uma nova data valida para o usuário
        ...
        {
            Cursor = Cursors.WaitCursor;
            //chamda do metodo para buscar as datas  validas para o usuário
        ...
        {
            Cursor = Cursors.WaitCursor;
            //Chamando a função para buscar todas as digitais
        ...
        {
            Cursor = Cursors.WaitCursor;
            //Chamada da função para busca de usário
...
*/
        private void btnDownloadUser_Click(object sender, EventArgs e)
        {
            ...
            {  
                ...
                {
                    //Adicionando valores ao combobox de tipos de biometria
                ...
                UserMng.lbSysOutputInfo.Items.Add("Busca com sucesso");
            }
            Cursor = Cursors.Default;
        }
            ...
            if (UserMng.SDK.GetConnectState())
            {
                if (cmbBiometricType.SelectedItem != null)       
                {
                    ...
                    foreach (SDKHelper.BioTemplate template in newTemplates)
                    {
                        ...
                        item.SubItems.Add(template.valid_flag == 1 ? "Valido" : "Invalido");
                        item.SubItems.Add(template.is_duress == 0 ? "Falso" : "Verdadeiro");
                        ...
                        item.SubItems.Add(template.data_format == 0 ? "ZK" : "Outro");
                    ...
                    UserMng.PrgSTA.Value = 100;
                    UserMng.lbSysOutputInfo.Items.Add("Busca  " + strType + " : " + CountTemplate);
                    UserMng.lbSysOutputInfo.Items.Add("Busca com sucesso");
                }
            }
            Cursor = Cursors.Default;
...
//          UserMng.SDK.bioTemplateList.Clear();
            lstBiometric.Items.Clear();     //modificado 2017/11/23
            Cursor = Cursors.Default;
        }
        ...
        private void btnUploadBio_Click(object sender, EventArgs e)
        {
            ...
            if (UserMng.SDK != null && UserMng.SDK.GetConnectState())
            {
                ...
                {
                    UserMng.PrgSTA.Value = 100;
                    UserMng.lbSysOutputInfo.Items.Add("Envio com sucesso");
                }
            }
            Cursor = Cursors.Default;
        }
        ...
        private void cbExpires_SelectedIndexChanged(object sender, EventArgs e)
        {
