...
namespace StandaloneSDKDemo
{
    public partial class PersonalizeMngForm : Form
    {
        ...
        private void btn_getAllBell_Click(object sender, EventArgs e)
        {
            ...
            dt_allBell.Columns.Add("Habilitado", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Hora", System.Type.GetType("System.String"));
            ...
            dt_allBell.Columns.Add("Seg.", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Ter", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Qua", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Qui", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Sex", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Sab", System.Type.GetType("System.Int32"));
            dt_allBell.Columns.Add("Dom", System.Type.GetType("System.Int32"));
        ...
        private void btn_addEditBell_Click(object sender, EventArgs e)
        {
            ...
            //validand o id da campainha
            if (tb_bellID.Text == "" || tb_bellID.Text == "0")
            {
                PersonalizeMng.lbSysOutputInfo.Items.Add("*O ID da campainha não pode ser nulo ou 0");
                return;
            }
            ...
            switch (bellType)
            {
                case 0:
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*Iner delay não pode ser nulo.");
                        return;
                    }
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*Internal delay errado.");
                        return;
                    }
                    extDelay = 0;
                    break;
                case 1:
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*External delay não pode ser nulo.");
                        return;
                    }
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*External delay errado.");
                        return;
                    }
                ...
                case 2: 
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*Internal ou External não pode ser nulo.");
                        return;
                    }
                    ...
                    {
                        PersonalizeMng.lbSysOutputInfo.Items.Add("*Internal or External errado.");
                        return;
                    }
                    break;
            }

            //Repetições da capainha
        ...
        private void btn_adpictureFIle_Click(object sender, EventArgs e)
        {
            ...
            fileDialog.Title = "Por favor selecione uma imagemm.";
        ...
        {
            //valindo input do usuário
            if (adPictureFile == "")
            {
                PersonalizeMng.lbSysOutputInfo.Items.Add("Pir favor selecione uma imagem 320*218!");
                return;
            }
        ...
        private void btn_wallPath_Click(object sender, EventArgs e)
        {
            OpenFileDialog fileDialog = new OpenFileDialog();
            fileDialog.Multiselect = true;
            fileDialog.Title = "Por favor selecione uma imagem";
            fileDialog.Filter = "Imagem|*.png";
            if (fileDialog.ShowDialog() == DialogResult.OK)
            {
        ...
        private void btn_uploadwallpaper_Click(object sender, EventArgs e)
        {
            if (wallPaperFile == "")
            {
                PersonalizeMng.lbSysOutputInfo.Items.Add("*Por favor, selecione uma imagem primeiro!");
                return;
            }
        ...
        private void btn_setShortKey_Click(object sender, EventArgs e)
        {
            if (cb_stkeyName.SelectedIndex < 0)
            {
                PersonalizeMng.lbSysOutputInfo.Items.Add("*Por favor seleciome o nome do atalho!");
                return;
            }

            if (cb_function.SelectedIndex < 0)
            {
                PersonalizeMng.lbSysOutputInfo.Items.Add("*Por favor selecione uma função");
                return;
            }
            ...
            if (cb_function.Text == "state key")
            {
                ...
                if (stateCode > 250)
                {
                    PersonalizeMng.lbSysOutputInfo.Items.Add("* Invalid Punch State Value.");
                    return;
                }
