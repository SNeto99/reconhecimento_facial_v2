...
namespace StandaloneSDKDemo
{
    public partial class AccessMngForm : Form
    {
        ...
        {
            Cursor = Cursors.WaitCursor;
            //chamada da função para definir Delay  do alarme
        ...
        {
            Cursor = Cursors.WaitCursor;
            //Chamada da função para desligar o alarme
        ...
        private void btnGetNOTimeZone_Click(object sender, EventArgs e)
        {
            ...
            int iGetNo = 81;
            //chamada da função para defiir estado 
        ...
        private void txtUTZIndex2_TextChanged(object sender, EventArgs e)
        {
